...
public class AuthNHandler implements Handler<RoutingContext> {
    ...
    public AuthNHandler(ServiceDiscovery serviceDiscovery, CircuitBreaker circuitBreaker, ContextSwitchingService contextSwitchingService, WebClient webClient, Map<String, JsonObject> serviceEndPointsForWebClient) {
    ...
    public void handle(RoutingContext routingContext) {
        ...
        String path = httpServerRequest.uri();
                    ...
                    contextSwitchingService.getRegisteredEndPointRecords(this.serviceDiscovery, handler -> {
                        if (handler.succeeded()) {
                            ...
                            if (client.isPresent()) {
                                ...
                                contextSwitchingService.doDispatch(routingContext, path, serviceReference.getAs(HttpClient.class), promise, false, webClient, serviceEndPointsForWebClient);
                            } else {
